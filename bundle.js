...
},{"../config/keys":2,"./Book":5,"axios":9}],7:[function(require,module,exports){
const UI = {
  displayBook(book) {
    // Grab handlebars template in index.html
...
},{"./js/Book":5,"./js/search":6,"./js/ui":7}],9:[function(require,module,exports){
